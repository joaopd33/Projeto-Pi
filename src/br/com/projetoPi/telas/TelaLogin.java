  ...
  // criando metodo logar
   public void logar(){
       ...
       try {
           ...
           if(rs.next()){
               TelaPrincipal principal = new TelaPrincipal(); //chamando a tela principal
   ...
   public TelaLogin() {
        ...
        if (conexao != null){
            lblStatus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/projetoPi/icones/dbookk1.png")));
        } else{
            lblStatus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/projetoPi/icones/dberro1.png")));
        }
    }
    ...
    private void initComponents() {
        ...
        lblStatus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/projetoPi/icones/dbookk1.png"))); // NOI18N
